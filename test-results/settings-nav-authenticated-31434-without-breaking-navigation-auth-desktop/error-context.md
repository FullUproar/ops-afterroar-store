...
- Name: settings-nav.spec.ts >> authenticated: settings navigation >> can switch settings tabs without breaking navigation
- Location: tests\settings-nav.spec.ts:44:7
