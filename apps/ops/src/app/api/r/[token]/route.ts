...
/**
 * Public receipt lookup by token. No auth required — the token IS the auth.
 */
export async function GET(
  ...
  // Look up the ledger entry by receipt_token in metadata
  ...
  // Resolve item names from inventory
