...
const SIDEBAR_ITEMS: { href: string; label: string; icon: string; permission: Permission; feature?: FeatureModule }[] = [
  ...
  { href: "/dashboard/catalog", label: "Card Catalog", icon: "🃏", permission: "inventory.view", feature: "tcg_engine" as FeatureModule },
  ...
  { href: "/dashboard/fulfillment", label: "Fulfillment", icon: "📦", permission: "checkout", feature: "ecommerce" as FeatureModule },
